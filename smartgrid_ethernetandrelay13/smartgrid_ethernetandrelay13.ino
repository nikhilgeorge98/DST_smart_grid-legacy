 ...
 */ 
 ...
 pinMode(5,OUTPUT);
 digitalWrite(5, HIGH);
 uint8_t mac[6] = {0x00,0x01,0x03,0x05,0x04,0x02};
//Ethernet.begin(mac,IPAddress(192,168,1,37));
  Ethernet.begin(mac,IPAddress(172,1,14,37));
...
//    digitalWrite(LED_BUILTIN, HIGH);
  ...
  udp.beginPacket(IPAddress(172,1,28,85),6000);  //172,1,28,57
     udp.write(V);
    udp.write(",");
    udp.write(I);
     udp.write(",");
    ...
    udp.write(",");
     ...
     udp.beginPacket(IPAddress(172,1,26,131),6000);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
    ...
    udp.write(",");
     ...
     udp.beginPacket(IPAddress(172,1,14,104),6000);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
     udp.write(V);
    udp.write(",");
    udp.write(I);
    ...
    udp.write(",");
     ...
     udp.beginPacket(IPAddress(172,1,26,108),6000);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
     udp.write(V);
    udp.write(",");
    udp.write(I);
