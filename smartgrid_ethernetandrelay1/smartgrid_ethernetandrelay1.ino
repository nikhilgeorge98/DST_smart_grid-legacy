 ...
 */ 
 ...
 digitalWrite(4, HIGH);
 pinMode(5, OUTPUT);  // Led pin de Arduino Mega;
 digitalWrite(5, HIGH);
 pinMode(LED_BUILTIN, OUTPUT);
 uint8_t mac[6] = {0x00,0x01,0x02,0x05,0x04,0x03};
 
 //Ethernet.begin(mac,IPAddress(192,168,1,153));
  Ethernet.begin(mac,IPAddress(172,1,14,35));
...
// if( (millis()-oldMillis) > POLLING){
 ...
 if(Serial.available() > 0)
  ...
  udp.beginPacket(IPAddress(172,1,28,85),8000);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
    ...
    udp.write(",");
     ...
     udp.beginPacket(IPAddress(172,1,26,131),8000);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
     udp.write(V);
    udp.write(",");
    udp.write(I);
    ...
    udp.write(",");
     ...
     udp.beginPacket(IPAddress(172,1,26,108),8000);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
     udp.write(V);
    udp.write(",");
    udp.write(I);
    ...
    udp.write(",");
     ...
     udp.endPacket();
          ...
          udp.beginPacket(IPAddress(172,1,14,104),8000);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
     udp.write(V);
    udp.write(",");
    udp.write(I);
