 ...
 */ 
 ...
 //Ethernet.begin(mac,IPAddress(192,168,1,153));
  Ethernet.begin(mac,IPAddress(172,1,14,28));
  int success = udp.begin(6666);
...
// if( (millis()-oldMillis) > POLLING){
 ...
 if(Serial.available() > 0)
  ...
  udp.beginPacket(IPAddress(172,1,28,85),6666);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
    ...
    udp.write(",");
     ...
     udp.endPacket();
      ...
      udp.beginPacket(IPAddress(172,1,26,131),6666);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
     udp.write(V);
    udp.write(",");
    udp.write(I);
    ...
    udp.write(",");
     ...
     udp.beginPacket(IPAddress(172,1,26,108),6666);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
     udp.write(V);
    udp.write(",");
    udp.write(I);
    ...
    udp.write(",");
     ...
     udp.endPacket();
          ...
          udp.beginPacket(IPAddress(172,1,14,104),6666);
 //udp.beginPacket(IPAddress(192,168,1,216),7000);//172,1,28,57
     udp.write(V);
    udp.write(",");
    udp.write(I);
